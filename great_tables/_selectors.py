...
from ._tbl_data import DataFrameLike, PdDataFrame, PlDataFrame, PyArrowTable, _raise_not_implemented
...
def _get_bool_list(n_rows: int, n: int, offset: int) -> list[int]:
    if n > n_rows:
...
def _(data: PdDataFrame, n: int, offset: int) -> list[int]:
    import pandas as pd
...
def _(data: PlDataFrame, n: int, offset: int) -> list[int]:
    import polars as pl
...
def _(data: PyArrowTable, n: int, offset: int) -> list[int]:
